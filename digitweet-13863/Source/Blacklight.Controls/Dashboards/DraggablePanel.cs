...
namespace Blacklight.Controls
{
    ...
    public class DraggablePanel : AnimatedHeaderedContentControl
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            UIElement gripBarElement = this.GetTemplateChild(DraggablePanel.ElementGripBarElement) as UIElement;
        ...
        private void GripBarElement_MouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
            ...
            // this came before the DraggingEnabled check because we want to enable double clicking even when a panel is maximized
            // this code is custom to DragDockPanel, and may break DraggablePanel
            if ((DateTime.Now.Ticks - lastClicked) < 4000000)
            {
                this.GripBarElement_MouseDoubleClick(sender, e);
                return;
            }
        ...
        /// <summary>
        /// Mouse double click event on grip bar
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void GripBarElement_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            // Bring the panel to the front
            Canvas.SetZIndex(this, CurrentZIndex++);

            if (this.PanelDoubleClicked != null)
            {
                this.PanelDoubleClicked(this, EventArgs.Empty);
            }
        }
